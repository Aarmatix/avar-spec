...
- **Related:** `docs/access-model/EGRESS-ROADMAP.md`, `packages/cli/src/commands/trust.ts`, `mem://product/egress-coverage-honesty`, `mem://strategy/marketing-and-moat`
...
3. Un-adapted "escape-hatch" HTTPS is allowed or denied at the FQDN level only. Its limited receipt fidelity is disclosed transparently per the egress honesty rules in `mem://product/egress-coverage-honesty`.
