...
**Positive**
- No root CA install required to get value from Aarmos. Preserves vendor-neutral, device-resident invariants.
...
- **Option 3 — MITM on by default.** Rejected: violates every locked invariant (vendor neutrality, device-resident operation, no overpromising).
